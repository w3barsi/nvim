...
vim.keymap.set('n', ',p', function() harpoon.ui:toggle_quick_menu(harpoon:list()) end, { desc = 'Open Harpoon Quick Menu' })
...
vim.keymap.set('n', 'qc', ":cexpr []<CR>:cclose<CR>:echo 'Quickfix List Cleared'<CR>", { desc = '[Q]uickfix list [C]lear then close', silent = true })
